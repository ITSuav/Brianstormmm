...
export const geospatialLayers: readonly GeospatialLayer[] = [
  {
    ...
    productPath: publicAssetPath('assets/geospatial/hk-gee-dem-heightmap.png'),
    status: 'available',
  ...
  },
  {
    ...
    productPath: publicAssetPath('assets/geospatial/hk-gee-sentinel2-texture.png'),
    status: 'available',
  ...
  },
  {
    ...
    productPath: publicAssetPath('assets/geospatial/hk-gee-slope.png'),
    status: 'available',
  ...
  },
  {
    ...
    productPath: publicAssetPath('assets/geospatial/hk-gee-risk-surface.png'),
    status: 'available',
...
export const digitalTwinAssets: readonly DigitalTwinAsset[] = [
  {
    ...
    productPath: publicAssetPath('assets/drone-twin/hkstp/hk-gee-blender-terrain.png'),
    status: 'available',
  ...
  },
  {
    ...
    productPath: publicAssetPath('assets/drone-twin/hkstp/hk-gee-terrain-model.glb'),
    status: 'available',
  ...
  },
  {
    ...
    productPath: publicAssetPath('assets/drone-twin/hkstp/splats/'),
    status: 'required',
