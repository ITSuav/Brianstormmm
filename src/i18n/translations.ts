...
export const translations: Readonly<Record<Locale, AppCopy>> = {
  en: {
    ...
    sections: {
      ...
      route: 'Route intake and simulation handoff',
    ...
    route: {
      ...
      name: 'HKSTP to eastern hills lunch run',
      description: 'Upload the route package when the planning team hands it off. Operators review launch, delivery, and return status from this screen.',
      upload: 'Import route package',
      uploadAria: 'Import route package from planning team',
    },
    interfaces: {
      matsim: 'Traffic simulation',
      matsimValue: 'integration slot',
      telemetry: 'Fleet telemetry',
      telemetryValue: 'ready',
      mapStack: 'Customer board',
      mapStackValue: 'next phase',
    },
    ...
    metrics: [
      ...
      { label: 'Partner slots', value: '2', trend: 'awaiting handoff' },
    ],
    timeline: [
      { label: 'Restaurant prep sync' },
      { label: 'Lunch route intake' },
      { label: 'Peak dispatch window' },
      { label: 'Simulation handoff' },
    ],
  },
  zhHans: {
    htmlLang: 'zh-Hans',
    ...
    route: {
      panelTitle: '路线导入',
      name: '香港科学园至东部山地午餐配送',
      description: '路线规划团队交付后，运营员在此导入路线包，并查看起飞、送达与返航状态。',
      upload: '导入路线包',
      uploadAria: '导入路线规划团队提供的路线包',
    },
    interfaces: {
      matsim: '交通仿真',
      matsimValue: '接口预留',
    ...
    collaboration: {
      ...
      routeAlgorithmValue: '等待交付',
      trafficSimulation: '交通仿真团队',
      trafficSimulationValue: '接口预留',
      restaurantOps: '餐厅运营',
      restaurantOpsValue: '出餐窗口就绪',
      operationsApi: '总控接口',
      operationsApiValue: '契约就绪',
    },
  ...
  zhHant: {
    ...
    route: {
      panelTitle: '路線匯入',
      name: '香港科學園至東部山地午餐配送',
      description: '路線規劃團隊交付後，營運員在此匯入路線包，並查看起飛、送達與返航狀態。',
      upload: '匯入路線包',
      uploadAria: '匯入路線規劃團隊提供的路線包',
    },
    interfaces: {
      matsim: '交通模擬',
      matsimValue: '介面預留',
    ...
    collaboration: {
      ...
      trafficSimulationValue: '介面預留',
      restaurantOps: '餐廳營運',
      restaurantOpsValue: '出餐窗口就緒',
      operationsApi: '總控介面',
      operationsApiValue: '契約就緒',
    },
